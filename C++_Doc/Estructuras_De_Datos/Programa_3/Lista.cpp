...
void ListaDobleLigada::top(){
    cout << "Top: " << head->get_tipoDato_actual()->toString() << endl;
}

void ListaDobleLigada::last(){
    cout << "Top: " << tail->get_tipoDato_actual()->toString() << endl;
}

void ListaDobleLigada::previous(){
    if (tail->anterior)
    cout << "Previous: " << tail->anterior->get_tipoDato_actual()->toString() << endl;

}

void ListaDobleLigada::next(){
    if (head->siguiente)
        cout << "Next: " << head->siguiente->get_tipoDato_actual()->toString() << endl;
...
void ListaDobleLigada::print_tail_to_head(){
    ...
    cout << "t" << endl;
    while (tmp){
        cout << tmp->get_tipoDato_actual()->toString() << endl;
        tmp = tmp->anterior;
    }
    cout << "h" << endl;
}
...
void print_to_head(Nodo* nodo ){
    ...
    cout << nodo->get_tipoDato_actual()->toString() << endl;
}
